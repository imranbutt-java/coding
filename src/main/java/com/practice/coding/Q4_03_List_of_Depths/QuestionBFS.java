package com.practice.coding.Q4_03_List_of_Depths;
...
public class QuestionBFS {
	...
	public static void main(String[] args) {
		...
		ArrayList<LinkedList<TreeNode>> list = createLevelLinkedList2(root);//createLevelLinkedList(root);
		printResult(list);
	}
	
	public static void createLevelList(TreeNode root, ArrayList<LinkedList<TreeNode>> lists, int level) {
		if(root == null) return;
